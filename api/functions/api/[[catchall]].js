export async function onRequest(context) {
    ...
    // Forward the exact pathname and query parameters to the main worker
    ...
    try {
        ...
        return new Response(JSON.stringify({ error: "API proxy to worker failed", detail: err.message }), {
            status: 502,
